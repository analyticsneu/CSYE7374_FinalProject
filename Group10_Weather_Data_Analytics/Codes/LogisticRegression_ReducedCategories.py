...
#creating a key-value pair with unique output values
...
for weights in list_weights:
    weighted_value = np.dot(np.transpose(test_list),weights)
    print ("weighted_value:"+str(weighted_value))
